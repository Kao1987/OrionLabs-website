...
const router = createRouter({
  ...
  routes: [
    ...
    // 法遵頁面
    {
      ...
      meta: {
        title: "隱私權政策",
        description: "OrionLabs 隱私權政策，說明我們如何收集、使用和保護您的個人資料。",
        keywords: ["隱私權政策", "個人資料保護", "資料安全"],
        type: "website",
        noindex: true,
      },
    },
    {
      ...
      meta: {
        title: "服務條款",
        description: "OrionLabs 服務條款，規範網站使用規則和用戶權利義務。",
        keywords: ["服務條款", "使用條款", "用戶協議"],
        type: "website",
        noindex: true,
      },
    },
    {
      ...
      meta: {
        title: "Cookie 使用聲明",
        description: "OrionLabs Cookie 使用聲明，說明網站如何使用 Cookie 和追蹤技術。",
        keywords: ["Cookie 政策", "Cookie 使用", "網站追蹤"],
        type: "website",
        noindex: true,
      },
    },
